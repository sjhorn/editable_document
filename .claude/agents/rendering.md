...
4. For visual changes: update goldens only via `flutter test --update-goldens` on Linux.
...
Update goldens only with: `flutter test --update-goldens test/src/rendering/`
